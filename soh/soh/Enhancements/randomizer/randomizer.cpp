...
void Randomizer::CreateCustomMessages() {
    ...
    const std::array<GetItemMessage, 124> vanillaTableGetItemMessages = {{
        GIMESSAGE(GI_NONE, ITEM_NONE,
            ...
            "%rTEXT ID ERROR!%w",
            "%rTEXT ID ERROR!%w"),
        GIMESSAGE(GI_BOMBS_5, ITEM_BOMBS_5,
            "You found %r5 Bombs%w!",
            "",
            "Vous obtenez %r5 Bombes%w!"),
        GIMESSAGE(GI_NUTS_5, ITEM_NUTS_5,
            "You found %r5 Deku Nuts%w!",
            "",
            "Vous obtenez %r5 Noix Mojo%w!"),
        GIMESSAGE(GI_BOMBCHUS_10, ITEM_BOMBCHU,
            "You found %r10 Bombchus%w!",
            "",
            "Vous obtenez %r10 Missiles&Teigneux%w!"),
        ...
        GIMESSAGE(GI_STICKS_1, ITEM_STICK,
            "You got a %rDeku Stick%w!",
            "",
            "Vous obtenez un %rBâton Mojo%w!"),
        ...
        GIMESSAGE(GI_LONGSHOT, ITEM_LONGSHOT,
            "You found the %rLongshot%w!&It extends %rtwice%w as far!",
            "",
            ""),
        ...
        GIMESSAGE(GI_LETTER_ZELDA, ITEM_LETTER_ZELDA,
            "You received %rZelda's Letter%w!&Wow! This letter has Princess&Zelda's autograph!",
            "",
            ""),
        ...
        GIMESSAGE(GI_COJIRO, ITEM_COJIRO,
            "You found %rCojiro%w!&Unlike other Cuccos, Cojiro&rarely crows.",
            "",
            ""),
        GIMESSAGE(GI_BOTTLE, ITEM_BOTTLE,
            "You got an %rEmpty Bottle%w!&You can put something in this&bottle.",
            "",
            ""),
        GIMESSAGE(GI_POTION_RED, ITEM_NONE,
            "You got a %rRed Potion%w!&It will restore your health",
            "",
            ""),
        GIMESSAGE(GI_POTION_GREEN, ITEM_NONE,
            "You got a %gGreen Potion%w!&It will restore your magic.",
            "",
            ""),
        GIMESSAGE(GI_POTION_BLUE, ITEM_NONE,
            "You got a %bBlue Potion%w!&It will recover your health&and magic.",
            "",
            ""),
        GIMESSAGE(GI_FAIRY, ITEM_NONE,
            "You caught a %rFairy%w in a bottle!&It will revive you&the moment you run out of life &energy.",
            "",
            ""),
        GIMESSAGE(GI_MILK_BOTTLE, ITEM_NONE,
            "You got %rLon Lon Milk%w!&This milk is very nutritious!&There are two drinks in it.",
            "",
            ""),
        GIMESSAGE(GI_LETTER_RUTO, ITEM_NONE,
            "You found %rRuto's Letter%w in a&bottle! Show it to King Zora.",
            "",
            ""),
        GIMESSAGE(GI_BEAN, ITEM_NONE,
            "You got a %rMagic Bean%w!&Find a suitable spot for a garden&and plant it.",
            "",
            ""),
        GIMESSAGE(GI_MASK_SKULL, ITEM_NONE,
            "You got a %rSkull Mask%w.&You feel like a monster while you&wear this mask!",
            "",
            ""),
        GIMESSAGE(GI_MASK_SPOOKY, ITEM_NONE,
            "You got a %rSpooky Mask%w.&You can scare many people&with this mask!",
            "",
            ""),
        GIMESSAGE(GI_CHICKEN, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_MASK_KEATON, ITEM_NONE,
            "You got a %rKeaton Mask%w.&You'll be a popular guy with&this mask on!",
            "",
            ""),
        GIMESSAGE(GI_MASK_BUNNY, ITEM_NONE,
            "You got a %rBunny Hood%w.&The hood's long ears are so&cute!",
            "",
            ""),
        GIMESSAGE(GI_MASK_TRUTH, ITEM_NONE,
            "You got a %rMask of Truth%w.&Show it to many people!",
            "",
            ""),
        GIMESSAGE(GI_POCKET_EGG, ITEM_NONE,
            "You borrowed a %rPocket Egg%w!&A Pocket Cucco will hatch from&it overnight. Be sure to give it&back.",
            "",
            ""),
        GIMESSAGE(GI_POCKET_CUCCO, ITEM_NONE,
            "You got a %rPocket Cucco%w, one&of Anju's prized hens! It fits &in your pocket.",
            "",
            ""),
        GIMESSAGE(GI_ODD_MUSHROOM, ITEM_NONE,
            "You got an %rOdd Mushroom%w!&It is sure to spoil quickly! Take&it to the Kakariko Potion Shop.",
            "",
            ""),
        GIMESSAGE(GI_ODD_POTION, ITEM_NONE,
            "You received an %rOdd Potion%w!&It may be useful for something...&Hurry to the Lost Woods!",
            "",
            ""),
        GIMESSAGE(GI_SAW, ITEM_NONE,
            "You returned the Odd Potion &and got the %rPoacher's Saw%w!&The young punk guy must have&left this.",
            "",
            ""),
        GIMESSAGE(GI_SWORD_BROKEN, ITEM_NONE,
            "You traded the Poacher's Saw &for a %rBroken Goron's Sword%w!&Visit Biggoron to get it repaired!",
            "",
            ""),
        GIMESSAGE(GI_PRESCRIPTION, ITEM_NONE,
            "You checked in the Broken &Goron's Sword and received a &%rPrescription%w!&Go see King Zora!",
            "",
            ""),
        GIMESSAGE(GI_FROG, ITEM_NONE,
            "You used the Prescription and&received an %rEyeball Frog%w!&Be quick and deliver it to Lake &Hylia!",
            "",
            ""),
        GIMESSAGE(GI_EYEDROPS, ITEM_NONE,
            "You traded the Eyeball Frog &for the %rWorld's Finest Eye Drops%w!&Hurry! Take them to Biggoron!",
            "",
            ""),
        GIMESSAGE(GI_CLAIM_CHECK, ITEM_NONE,
            "The Biggoron's Sword...&You got a %rClaim Check %wfor it!&You can't wait for the sword!",
            "",
            ""),
        ...
        GIMESSAGE(GI_SWORD_KNIFE, ITEM_NONE,
            "You got the %gGiant's Knife%w!&Hold it with both hands to&attack! It's so long, you&can't use it with a %cshield%w.",
            "",
            ""),
        ...
        GIMESSAGE(GI_TUNIC_GORON, ITEM_TUNIC_GORON,
            "You got a %rGoron Tunic%w!&Going to a hot place? No worry!",
            "",
            ""),
        GIMESSAGE(GI_TUNIC_ZORA, ITEM_TUNIC_ZORA,
            "You got a %bZora Tunic%w!&Wear it, and you won't drown&underwater.",
            "",
            ""),
        GIMESSAGE(GI_BOOTS_IRON, ITEM_BOOTS_IRON,
            "You got the %rIron Boots%w!&So heavy, you can't run.&So heavy, you can't float.",
            "",
            ""),
        GIMESSAGE(GI_BOOTS_HOVER, ITEM_BOOTS_HOVER,
            ...
            "",
            ""),
        GIMESSAGE(GI_QUIVER_40, ITEM_QUIVER_40,
            "You found a %rBig Quiver%w!&Now you can carry more arrows&%y40 %win total!",
            "",
            ""),
        GIMESSAGE(GI_QUIVER_50, ITEM_QUIVER_50,
            "You found the %rBiggest Quiver%w!&Now you can carry to a&maximum of %y50%w arrows!",
            "",
            ""),
        GIMESSAGE(GI_BOMB_BAG_20, ITEM_BOMB_BAG_20,
            "You found a %rBomb Bag%w!&You found %r20 Bombs%w inside!",
            "",
        ...
        GIMESSAGE(GI_BOMB_BAG_40, ITEM_NONE,
            "You got the %rBiggest Bomb Bag%w!&Now, you can carry up to %y40%w&Bombs!",
            "",
            ""),
        ...
        GIMESSAGE(GI_STONE_OF_AGONY, ITEM_NONE,
            "You obtained the %rStone of Agony%w!&If you enable the %cRumbles%w, it&will react to nearby...secrets.",
            "",
            ""),
        GIMESSAGE(GI_GERUDO_CARD, ITEM_NONE,
            "You obtained the %rGerudo's &Membership Card%w!&You can get into the Gerudo's&training ground.",
            "",
            ""),
        ...
        GIMESSAGE(GI_SEEDS_5, ITEM_NONE,
            "8You got %rDeku Seeds%w!&Use these as bullets&for your Slingshot",
            "",
            ""),
        GIMESSAGE(GI_HEART_CONTAINER, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_HEART_PIECE, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_KEY_BOSS, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_COMPASS, ITEM_NONE,
            "You found the %rCompass%w!&Now you can see the locations&of many hidden things in the&dungeon!",
            "",
            ""),
        GIMESSAGE(GI_MAP, ITEM_NONE,
            "You found the %rDungeon Map%w!&It's the map to this dungeon.",
            "",
            ""),
        GIMESSAGE(GI_KEY_SMALL, ITEM_NONE,
            "You found a %rSmall Key%w!&This key will open a locked &door. You can use it only&in this dungeon.",
            "",
            ""),
        GIMESSAGE(GI_MAGIC_SMALL, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_MAGIC_LARGE, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_WALLET_ADULT, ITEM_NONE,
            "You got an %bAdult's Wallet%w!&Now you can hold up to &%y200%w %yRupees%w.",
            "",
            ""),
        GIMESSAGE(GI_WALLET_GIANT, ITEM_NONE,
            "You got a %bGiant's Wallet%w!&Now you can hold up to &%y500%w %yRupees%w.",
            "",
            ""),
        GIMESSAGE(GI_WEIRD_EGG, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_HEART, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_ARROWS_SMALL, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_ARROWS_MEDIUM, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_ARROWS_LARGE, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_RUPEE_GREEN, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_RUPEE_BLUE, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_RUPEE_RED, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_HEART_CONTAINER_2, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_MILK, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_MASK_GORON, ITEM_NONE,
            "You got a %rGoron Mask%w.&It will make your head look&big, though.",
            "",
            ""),
        GIMESSAGE(GI_MASK_ZORA, ITEM_NONE,
            "You got a %rZora Mask%w.&With this mask, you can&become one of the Zoras!",
            "",
            ""),
        GIMESSAGE(GI_MASK_GERUDO, ITEM_NONE,
            "You got a %rGerudo Mask%w.&This mask will make you look&like...a girl?",
            "",
            ""),
        ...
        GIMESSAGE(GI_RUPEE_PURPLE, ITEM_NONE,
            "You got a %pPurple Rupee%w!&That's %pfifty Rupees%w!",
            "",
            ""),
        GIMESSAGE(GI_RUPEE_GOLD, ITEM_NONE,
            "You got a %yHuge Rupee%w!&This Rupee is worth a whopping&%ytwo hundred Rupees%w!",
            "",
            ""),
        ...
        GIMESSAGE(GI_SKULL_TOKEN, ITEM_NONE,
            "",
            "",
            ""),
        ...
        GIMESSAGE(GI_BULLET_BAG_30, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_BULLET_BAG_40, ITEM_NONE,
            "You got a %rDeku Seeds Bullet Bag%w.&This bag can hold up to %y40%w&slingshot bullets.",
            "",
            ""),
        GIMESSAGE(GI_STICKS_5, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_STICKS_10, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_NUTS_5_2, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_NUTS_10, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_BOMBS_1, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_BOMBS_10, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_BOMBS_20, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_BOMBS_30, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_SEEDS_30, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_BOMBCHUS_5, ITEM_BOMBCHU,
            ...
            "fff",
            "fff"),
        GIMESSAGE(GI_BOMBCHUS_20, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_FISH, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_BUGS, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_BLUE_FIRE, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_POE, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_BIG_POE, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_DOOR_KEY, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_RUPEE_GREEN_LOSE, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_RUPEE_BLUE_LOSE, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_RUPEE_RED_LOSE, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_RUPEE_PURPLE_LOSE, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_HEART_PIECE_WIN, ITEM_NONE,
            "",
            "",
            ""),
        GIMESSAGE(GI_STICK_UPGRADE_20, ITEM_NONE,
            "You can now pick up &more %rDeku Sticks%w!&You can carry up to %y20%w of them!",
            "",
            ""),
        GIMESSAGE(GI_STICK_UPGRADE_30, ITEM_NONE,
            "You can now pick up &even more %rDeku Sticks%w!&You can carry up to %y30%w of them!",
            "",
            ""),
        GIMESSAGE(GI_NUT_UPGRADE_30, ITEM_NONE,
            "You can now carry more&%rDeku Nuts%w! You can carry&up to %y40%r %wnuts!",
            "",
            ""),
        GIMESSAGE(GI_NUT_UPGRADE_40, ITEM_NONE,
            "You can now carry even&more %rDeku Nuts%w! You can carry&up to %y40%r %wnuts!",
            "",
            ""),
        GIMESSAGE(GI_BULLET_BAG_50, ITEM_NONE,
            "You got an even bigger %rDeku&Seeds Bullet Bag%w!&This bag can hold %y50%r %wbullets!",
            "",
            "")
    }};
    ...
    const std::vector<GetItemMessage> randomizerTableGetItemMessages = {{ 
        GIMESSAGE(RG_ZELDAS_LULLABY, ITEM_NONE,
			...
			" ",
            " "),
        GIMESSAGE(RG_EPONAS_SONG, ITEM_NONE,
			" ",
			" ",
            " "),
        GIMESSAGE(RG_SARIAS_SONG, ITEM_NONE,
			" ",
			" ",
            " "),
        GIMESSAGE(RG_SUNS_SONG, ITEM_NONE,
			" ",
			" ",
            " "),
        GIMESSAGE(RG_SONG_OF_TIME, ITEM_NONE,
			" ",
			" ",
            " "),
        GIMESSAGE(RG_SONG_OF_STORMS, ITEM_NONE,
			" ",
			" ",
            " "),

        GIMESSAGE(RG_MINUET_OF_FOREST, ITEM_NONE,
			" ",
			" ",
            " "),
        GIMESSAGE(RG_BOLERO_OF_FIRE, ITEM_NONE,
			" ",
			" ",
            " "),
        GIMESSAGE(RG_SERENADE_OF_WATER, ITEM_NONE,
			" ",
			" ",
            " "),
        GIMESSAGE(RG_REQUIEM_OF_SPIRIT, ITEM_NONE,
			" ",
			" ",
            " "),
        GIMESSAGE(RG_NOCTURNE_OF_SHADOW, ITEM_NONE,
			" ",
			" ",
            " "),
        GIMESSAGE(RG_PRELUDE_OF_LIGHT, ITEM_NONE,
			" ",
			" ",
            " "),

        GIMESSAGE(RG_FOREST_MEDALLION, ITEM_MEDALLION_FOREST,
			" ",
			" ",
            " "),
        GIMESSAGE(RG_FIRE_MEDALLION, ITEM_MEDALLION_FIRE,
			" ",
			" ",
            " "),
        GIMESSAGE(RG_WATER_MEDALLION, ITEM_MEDALLION_WATER,
			" ",
			" ",
            " "),
        GIMESSAGE(RG_SPIRIT_MEDALLION, ITEM_MEDALLION_SPIRIT,
			" ",
			" ",
            " "),
        GIMESSAGE(RG_SHADOW_MEDALLION, ITEM_MEDALLION_SHADOW,
			" ",
			" ",
            " "),
        GIMESSAGE(RG_LIGHT_MEDALLION, ITEM_MEDALLION_LIGHT,
			" ",
			" ",
            " "),
        GIMESSAGE(RG_KOKIRI_EMERALD, ITEM_KOKIRI_EMERALD,
			" ",
			" ",
            " "),
        GIMESSAGE(RG_GORON_RUBY, ITEM_GORON_RUBY,
			" ",
			" ",
            " "),
        GIMESSAGE(RG_ZORA_SAPPHIRE, ITEM_ZORA_SAPPHIRE,
			" ",
			" ",
            " "),
