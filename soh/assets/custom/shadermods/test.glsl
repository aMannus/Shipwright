...
@else
    ...
    void main() {
        ...
        @if(o_alpha)
            ...
            texel.rgb = vec3(
                0.5 + 0.5 * cos(float(frame_count) * 0.1 + gl_FragCoord.x * 0.1),
                0.5 + 0.5 * cos(float(frame_count) * 0.1 + gl_FragCoord.x * 0.1 + 2.094), // +120 degrees
                0.5 + 0.5 * cos(float(frame_count) * 0.1 + gl_FragCoord.x * 0.1 + 4.188) // +240 degrees
            );
