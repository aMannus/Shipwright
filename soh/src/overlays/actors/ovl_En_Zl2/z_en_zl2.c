...
void EnZl2_GiveLightArrows(EnZl2* this, PlayState* play) {
    ...
    if (this->unk_244 == 0) {
        ...
        OTRActor_Spawn(&play->actorCtx, play, ACTOR_DEMO_EFFECT, posX, posY, posZ, 0, 0, 0, 0x17);
...
void func_80B4FF84(EnZl2* this, PlayState* play) {
    ...
    if (this->unk_250 == 0) {
        ...
        OTRActor_Spawn(&play->actorCtx, play, ACTOR_DOOR_WARP1, posX, posY, posZ, 0, 0, 0, WARP_YELLOW);
        this->unk_250 = 1;
    }
}
...
void func_80B513A8(EnZl2* this, PlayState* play) {
    ...
    if (this->unk_250 == 0) {
        ...
        posZ = player->actor.world.pos.z;
        OTRActor_Spawn(&play->actorCtx, play, ACTOR_DOOR_WARP1, posX, posY, posZ, 0, 0, 0, WARP_UNK_7);
        this->unk_250 = 1;
    }
}
