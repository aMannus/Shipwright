...
void BossVa_rUpdate(Actor* thisx, PlayState* play);
...
void BossVa_rUpdate(Actor* thisx, PlayState* play2) {
    BossVa_Update(thisx, play2);
    BossVa* this = (BossVa*)thisx;
    Player* player = GET_PLAYER(play2);
    if (!Player_InBlockingCsMode(play2, player) && this->actor.params == BOSSVA_BODY) {
