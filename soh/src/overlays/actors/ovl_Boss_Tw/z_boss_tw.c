...
void BossTw_Init(Actor* thisx, PlayState* play2) {
    ...
    if (this->actor.params == TW_KOTAKE) {
        ...
        if (Flags_GetClear(play, play->roomCtx.curRoom.num)) {
            ...
            OTRActor_Spawn(&play->actorCtx, play, ACTOR_ITEM_B_HEART, -600.0f, 230.0f, 0.0f, 0, 0, 0, 0);
        } else {
    ...
    switch (this->csState2) {
        ...
        case 3:
            ...
            if (this->work[CS_TIMER_2] >= 1020) {
                ...
                OTRActor_Spawn(&play->actorCtx, play, ACTOR_ITEM_B_HEART, -600.0f, 230.f, 0.0f, 0, 0, 0, 0);
                this->actor.world.pos.y = -2000.0f;
