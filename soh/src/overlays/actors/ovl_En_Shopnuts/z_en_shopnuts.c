...
void EnShopnuts_ThrowNut(EnShopnuts* this, PlayState* play) {
    ...
    if (this->actor.xzDistToPlayer < 120.0f) {
        ...
        if (OTRActor_Spawn(&play->actorCtx, play, ACTOR_EN_NUTSBALL, spawnPos.x, spawnPos.y, spawnPos.z,
...
void EnShopnuts_SpawnSalesman(EnShopnuts* this, PlayState* play) {
    if (SkelAnime_Update(&this->skelAnime)) {
        OTRActor_Spawn(&play->actorCtx, play, ACTOR_EN_DNS, this->actor.world.pos.x, this->actor.world.pos.y,
