...
void func_80B53614(EnZl3* this, PlayState* play) {
    OTRActor_Spawn(&play->actorCtx, play, ACTOR_EN_RIVER_SOUND, -442.0f, 4102.0f, -371.0f, 0, 0, 0, 0x12);
}
...
void func_80B54EA4(EnZl3* this, PlayState* play) {
    ...
    OTRActor_Spawn(&play->actorCtx, play, ACTOR_EN_EG, posX, posY, posZ, 0, 0, 0, 0);
}
...
void func_80B57754(EnZl3* this, PlayState* play) {
    if (gSaveContext.unk_13F0 == 0) {
        OTRActor_Spawn(&play->actorCtx, play, ACTOR_OCEFF_WIPE4, this->actor.world.pos.x,
...
void func_80B577BC(PlayState* play, Vec3f* vec) {
    ...
    OTRActor_Spawn(&play->actorCtx, play, ACTOR_EN_TEST, posX, posY, posZ, 0,
...
void func_80B59828(EnZl3* this, PlayState* play) {
    ...
    if (func_80B59698(this, play) != 0) {
        ...
        if (Flags_GetSwitch(play, 0x20)) {
            ...
            OTRActor_Spawn(&play->actorCtx, play, ACTOR_BG_ZG, -144.0f, 3544.0f, -43.0f, 0, 0x2000, 0, 0x2000);
        }
