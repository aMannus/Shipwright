...
void BossDodongo_Init(Actor* thisx, PlayState* play) {
    ...
    if (Flags_GetClear(play, play->roomCtx.curRoom.num)) { // KD is dead
        ...
        OTRActor_Spawn(&play->actorCtx, play, ACTOR_BG_BREAKWALL, -890.0f, -1523.76f, -3304.0f, 0, 0, 0, 0x6000);
        OTRActor_Spawn(&play->actorCtx, play, ACTOR_ITEM_B_HEART, -690.0f, -1523.76f, -3304.0f, 0, 0, 0, 0);
    ...
    switch (this->csState) {
        ...
        case 5:
            ...
            if (Animation_OnFrame(&this->skelAnime, Animation_GetLastFrame(&object_kingdodongo_Anim_002D0C))) {
                ...
                this->csState = 6;
                OTRActor_Spawn(&play->actorCtx, play, ACTOR_BG_BREAKWALL, -890.0f, -1523.76f, -3304.0f, 0, 0, 0,
                            0x6000);
            }
            break;
        case 6:
