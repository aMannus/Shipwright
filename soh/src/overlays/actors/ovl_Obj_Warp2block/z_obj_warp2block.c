...
void ObjWarp2block_Spawn(ObjWarp2block* this, PlayState* play) {
    OTRActor_Spawn(&play->actorCtx, play, ACTOR_DEMO_EFFECT, this->dyna.actor.world.pos.x,
                this->dyna.actor.world.pos.y, this->dyna.actor.world.pos.z, 0, 0, 0,
                sSpawnData[(this->dyna.actor.params >> 8) & 1].params);

    OTRActor_Spawn(&play->actorCtx, play, ACTOR_DEMO_EFFECT, this->dyna.actor.child->world.pos.x,
