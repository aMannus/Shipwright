...
void EnChanger_Init(Actor* thisx, PlayState* play2) {
        ...
        if (this->finalChest != NULL) {
            if (this->roomChestsOpened) {
                ...
                rewardParams = ((gSaveContext.itemGetInf[1] & 0x800) ? (ITEM_ETC_RUPEE_PURPLE_CHEST_GAME)
                               ...
                               0xFF;
                OTRActor_Spawn(&play->actorCtx, play, ACTOR_ITEM_ETCETERA, 20.0f, 20.0f, -2500.0f, 0, 0, 0,
    ...
    if (this->rightChest != NULL) {
        ...
        OTRActor_Spawn(&play->actorCtx, play, ACTOR_ITEM_ETCETERA,
        ...
        switch (temp_s0_2) {
            case CHEST_LEFT:
                ...
                if (this->rightChestGetItemId == GI_DOOR_KEY) {
                    OTRActor_Spawn(&play->actorCtx, play, ACTOR_EN_EX_ITEM, xPos, yPos, zPos, 0, 0, 0, 0xF);
                    ...
                    OTRActor_Spawn(&play->actorCtx, play, ACTOR_EN_EX_ITEM, xPos, yPos, zPos, 0, 0, 0,
                                temp_s0_2);
                }
                break;
            case CHEST_RIGHT:
