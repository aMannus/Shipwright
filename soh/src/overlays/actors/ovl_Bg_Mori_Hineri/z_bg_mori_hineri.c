...
void BgMoriHineri_SpawnBossKeyChest(BgMoriHineri* this, PlayState* play) {
    if (this->dyna.actor.params == 0) {
        ...
        OTRActor_Spawn(&play->actorCtx, play, ACTOR_EN_BOX, -1515.0f, 1440.0f,  -3475.0f, -0x4000, 0x4000, 0, 0x27EE);
        this->actionFunc = func_808A3C8C;
    } else {
        OTRActor_Spawn(&play->actorCtx, play, ACTOR_EN_BOX, this->dyna.actor.world.pos.x + 147.0f,
