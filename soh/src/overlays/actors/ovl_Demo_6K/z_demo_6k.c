...
void func_80966E98(Demo6K* this, PlayState* play) {
    ...
    if (this->timer1 == 39) {
        ...
        OTRActor_Spawn(&play->actorCtx, play, ACTOR_DEMO_6K, this->actor.world.pos.x,
...
void func_80967F10(Demo6K* this, PlayState* play) {
    if (this->timer2 == 0) {
        OTRActor_Spawn(&play->actorCtx, play, ACTOR_DEMO_6K, this->actor.world.pos.x, this->actor.world.pos.y,
